const { Provider, util: { mergeDefault, mergeObjects, isObject } } = require('@sakaruzero/klasa');
const { MongoClient: Mongo } = require('mongodb');

module.exports = class extends Provider {

	constructor(...args) {
		super(...args, { description: 'MongoDB functionality' });
		this.db = null;
	}
	...
	async init() {
		...
		const mongoClient = await Mongo.connect(
			`mongodb://localhost:27017/curebotDEV`,
