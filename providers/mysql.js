const { SQLProvider, QueryBuilder, Timestamp, Type, util: { mergeDefault, isNumber, isObject } } = require('@sakaruzero/klasa');
...
module.exports = class extends SQLProvider {
	...
	async init() {
		const connection = mergeDefault({
			...
			database: 'DATABASE_DATABASE_HERE'
	...
	getColumns(table) {
		return this.runAll(`
			...
			WHERE \`TABLE_SCHEMA\` = ${sanitizeString(this.client.options.providers.mysql)}
